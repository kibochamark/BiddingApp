...
export default function Home() {
  return (
    <div className="bg-maroonsecondary w-full">
      <div className="md:grid md:grid-cols-4 px-6 py-8 md:mx-4">
        <div className="col-span-2">
          <div className="flex flex-col gap-4 justify-start items-start">
            ...
            <div className="flex flex-row items-center gap-6 justify-between my-4 w-full">
              <div className="rounded-full bg-[#212427] md:py-1 flex flex-col text-white w-1/4 text-center py-2">
                <h5 className="text-sm">23</h5>
                <p className="text-sm mb-1">Hours</p>
              </div>
              <div className="rounded-full bg-[#212427] md:py-1 flex flex-col text-white w-1/4 text-center py-2">
                <h5 className="text-sm">05</h5>
                <p className="text-sm mb-1">Days</p>
              </div>
              <div className="rounded-full bg-[#212427] md:py-1 flex flex-col text-white w-1/4 text-center py-2">
                <h5 className="text-sm">59</h5>
                <p className="text-sm mb-1">Minutes</p>
              </div>
              <div className="rounded-full bg-[#212427] md:py-1 flex flex-col text-white w-1/4 text-center py-2">
                <h5 className="text-sm">35</h5>
                <p className="text-sm mb-1">Seconds</p>
              </div>
            </div>
            <div className="my-2">
    ...
    <div className="mx-2 md:mx-4 rounded-lg overflow-hidden">
      <Image
        src="/Xbox-Series-X-and-Playstation-5-ps5.jpg"
        alt="hero"
        width={500}
        height={400}
